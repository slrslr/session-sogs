...
# 3. ideally after backing up the database, run "chmod 600 thisscriptname" and run a command to insert new hourly cronjob (first edit path inside that command and run the command without "# " at the begining):
